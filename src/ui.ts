...
export function buildUI() {
  ...
  <main class="experience">
    ...
    <aside id="settings" class="control-panel" aria-label="ゲーム設定" hidden inert>
      ...
      <label class="toggle-row"><span>レーンを帯で表示</span><input id="lane-guide-toggle" type="checkbox"/><span class="switch"></span></label>
      <p class="field-note" id="lane-legend" hidden>青：通路のレーン範囲<br/><span id="lane-stair-legend">緑 ↑ 上り · オレンジ ↓ 下り</span></p>
