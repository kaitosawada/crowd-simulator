...
- 初期500人、0〜1000人のNPCが両方の階に最初からいます。通り抜け（約40%）、買い物・飲食（約50%）、散策（約10%）を混ぜ、出入口と目的地を個別に選びます。買い物客は1〜2店舗に寄り、店先で滞在してから移動を再開します。滞在はキオスク約8〜18秒、カフェ約32〜68秒、書店約21〜45秒、マーケット約15〜33秒です。退出後は別の入口から新しい用事で出現します。体格・服装・速度にも個体差があり、移動距離に合わせて手足が動きます。
